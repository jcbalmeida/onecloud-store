# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-01-17 17:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('instance', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='computing.Instance')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='computing.OperatingSystem'),
        ),
    ]
